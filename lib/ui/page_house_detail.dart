...
import 'package:Roomazon/services/upload_image.dart';
import 'package:Roomazon/ui/page_profile.dart';
import 'package:Roomazon/ui/photo_list.dart';
import 'package:Roomazon/utils/Constants.dart';
import 'package:Roomazon/utils/responsive_screen.dart';
import 'package:Roomazon/widgets/utils_widget.dart';
import 'package:flutter/widgets.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter_swiper/flutter_swiper.dart';
import 'package:Roomazon/services/network_image.dart';
...
class _HouseDetailState extends State<HouseDetail> {
  ...
  void ownerDetail() async {
    ...
    Firestore.instance
        .document('/User/' + userReference)
        .get()
        .then((DocumentSnapshot ds) {
      print('Logged in with ' + ds['firstName']);
        ...
        body: Stack(
          children: <Widget>[
            ...
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: Colors.purple[700].withOpacity(1),
                ),
                height: 400,
              ),
            ),
                    ...
                    child: Container(
                      child: Column(
                        children: <Widget>[
                          ...
                          Container(
                            padding: new EdgeInsets.fromLTRB(15, 0, 5, 13),
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: Text(
                                'Security Deposit',
                  ...
                  ResponsiveContainer(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            padding: new EdgeInsets.fromLTRB(10, 13, 10, 0),
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: Row(
                                children: <Widget>[
                  ...
                  ResponsiveContainer(
                    ...
                    child: Container(
                      child: Column(
                        children: <Widget>[
                          Container(
                            padding: new EdgeInsets.fromLTRB(15, 13, 5, 0),
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: Text(
                                '' +
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Container(
                            padding: new EdgeInsets.fromLTRB(10, 0, 10, 13),
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: Text(
                                'Prefered Tanents',
      ...
      child: Card(
        ...
        child: InkWell(
          ...
          child: ClipRRect(
            borderRadius: new BorderRadius.circular(0.0),
            child: Container(
                padding: new EdgeInsets.fromLTRB(15, 16, 12, 16),
                child: Column(
                  children: <Widget>[
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border(
                            bottom: BorderSide(
                              //                   <--- left side
                              color: Colors.purple[500].withOpacity(0.6),
                              width: 3.0,
                            ),
                          ),
                        ),
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) => ProfilePage(
                            '/User/' + ownerSnapshot.documentID, true)));

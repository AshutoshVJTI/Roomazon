...
void createRecord(context) async {
  ...
  ref = await databaseReference.collection("House").add({
    'Address': address,
...
class _MultiImageState extends State<MultiImage> {
  ...
  Future<Null> _addImages(var pic) async {
    ...
    StorageReference ref =
        FirebaseStorage(storageBucket: 'gs://roomazon-f845b.appspot.com/')
            .ref()
            .child(filePath);
    ...
    setState(() {
      ...
      print("UploadStatus:" + _uploadStatus.toString());
    });
    // }
  }

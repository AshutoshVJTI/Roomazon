...
class SearchResultCityPage extends StatefulWidget {
  SearchResultCityPage(u) {
    userReff = u;
  }
  @override
  _SearchResultCityPageState createState() => _SearchResultCityPageState();
}

class _SearchResultCityPageState extends State<SearchResultCityPage> {
  Screen size;
  ...
  Widget build(BuildContext context) {
    ...
    setState(() {
      if (cityIndex == 0) selectedCity = 'Mumbai';
      if (cityIndex == 1) selectedCity = "Delhi";
      if (cityIndex == 2) selectedCity = "Chennai";
      if (cityIndex == 3) selectedCity = "Goa";
      if (cityIndex == 4) selectedCity = "Kolkata";
      if (cityIndex == 5) selectedCity = "Indore";
      if (cityIndex == 6) selectedCity = "Jaipur";
    });
                      ...
                      return Column(
                        ...
                        children: <Widget>[
                          ...
                          index == 0
                              ...
                              : SizedBox(height: 0),
                          if (docsSnap.data['Address']['city']
                              .contains(selectedCity))
                            getCard(docsSnap, context, index, userReff),
                        ],
                      );
                    },
                  ));
          ...
          Positioned(
            ...
            child: Center(
              child: ClipOval(
                  ...
                  //       Icons.favorite,
                  //       color:
                  //           _isPressed[index] ? Colors.purple[700] : Colors.grey,
                  //     ),
                  //     onPressed: () {
                  //       setState(() {
                  ...
                  //         });
                  //         // Firestore.instance.document(userReference).updateData({
                  //         //   'FavouriteHouse': FieldValue.arrayRemove(
                  //         //       ['/House/' + docsSnap.documentID])
                  //         // });
                  //       }
    ...
    return Padding(
      ...
      child: ChoiceChip(
        ...
        labelStyle: TextStyle(
            fontFamily: 'Exo2',
            color: (cityIndex == index) ? backgroundColor : textPrimaryColor),
        elevation: 4.0,
        padding: EdgeInsets.symmetric(
            vertical: size.getWidthPx(4), horizontal: size.getWidthPx(12)),
        selected: (cityIndex == index) ? true : false,
        label: Text(chipName),
        onSelected: (selected) {
          if (selected) {
            setState(() {

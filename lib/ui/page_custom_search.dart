...
class CustomSearchState extends State<CustomSearchPage> {
  ...
  // Value of Featured City starting from -1  in order mentioned in cityList[]

  String _locality;
  // 0 : Bunglow , 1 : Paying Guest, 2 : Hostel, 3 : Apartment
  var _selectedProperty = [];
  // 1 RK : 1 Room Kitchen | 1BHK | 2BHK | 3BHK | 4BHK | 4+BHK : Rooms >=5
  var _selectedRoom = [];
    ...
    return Padding(
      ...
      child: ChoiceChip(
        ...
        padding: EdgeInsets.symmetric(
            vertical: size.getWidthPx(8), horizontal: size.getWidthPx(12)),
          ...
          if (selected) {
            setState(() {
              ...
              if (_selectedIndex == 0)
                ...
                selectedCity = "Indore";
              else if (_selectedIndex == 6) selectedCity = "Jaipur";
            });
          }
        },
      ),

...
class _UsersState extends State<Users> {
  ...
  Widget build(BuildContext context) {
    ...
    FlutterStatusbarcolor.setStatusBarColor(Colors.purple[700]);
                  ...
                  : Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (docsSnap.data['firstName']
                                  .contains(searchResult) ||
                              docsSnap.data['lastName']
                                  .contains(searchResult) ||
                              docsSnap.data['city'].contains(searchResult)) {
                            return Column(
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (_) =>
                        ProfilePage('/User/' + docsSnap.documentID, true)));
